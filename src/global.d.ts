...
declare global {
  ...
  export class Hooks {
    ...
    static on(hook: string, fn: (...args: any) => void | boolean): number;
  }
  ...
  export class Combat extends ClientDocument {
    ...
    getEmbeddedDocument(document: string, id: string): Combatant | undefiend;
  ...
  class Dialog {
    constructor(data: object, options?: unknown);
